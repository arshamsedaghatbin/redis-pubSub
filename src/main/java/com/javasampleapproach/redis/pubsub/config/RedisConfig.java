package com.kiandigital.redis.pubsub.config;

import java.util.concurrent.Executors;

import com.javasampleapproach.redis.pubsub.consumer.CustomerInfoSubscriberCustom;
...
public class RedisConfig {
	...
	MessageListenerAdapter messageListenerCustom() {
		return new MessageListenerAdapter(new CustomerInfoSubscriberCustom());
	}
	...
	RedisMessageListenerContainer redisContainer() {
		...
		container.addMessageListener(messageListenerCustom(), topic());
